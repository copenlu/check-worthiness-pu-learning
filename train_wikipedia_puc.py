...
from datareader import PULearningPriorBasedConversionWikipediaCitationDataset
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gamma", help="Threshold for PN removal, 1.0 to disable", type=float, default=1.0)
    ...
    base_network.load_state_dict(torch.load(args.pretrained_model, map_location="cpu"))
    train_ds = PULearningPriorBasedConversionWikipediaCitationDataset(
        base_train_ds,
        val_ds,
        base_network,
        device,
