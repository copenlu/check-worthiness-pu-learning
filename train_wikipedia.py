...
if __name__ == "__main__":
    ...
    parser.add_argument("--warmup_steps", help="The batch size", type=int, default=200)
    ...
    # Create the datasets
    dset = WikipediaCitationDataset(args.pos_file, args.neg_file, BertTokenizer.from_pretrained(bert_model))
